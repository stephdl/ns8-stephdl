...
| BigBlueButton | Web conferencing with audio, video, screen sharing, shared notes and recording | [Code](https://github.com/stephdl/ns8-bigbluebutton) |
...
| PostgreSQLv18 | PostgreSQL v18 is a free and open-source relational database management system | [Code](https://github.com/stephdl/ns8-postgresql18) |
...
| sam | Audit and manage SSH authorized keys across your infrastructure. Detects anomalies, enforces ANSSI compliance, and provides a web UI for key lifecycle management. | [Code](https://github.com/stephdl/ssh-access-manager) |
| calrs | Self-hosted scheduling: publish your availability, let people book a slot in your CalDAV calendar | [Code](https://github.com/stephdl/ns8-calrs) |
| xwiki | XWiki is a free and open source wiki software platform | [Code](https://github.com/stephdl/ns8-xwiki) |
